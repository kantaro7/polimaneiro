    	...
    	<nav class="navbar-default navbar-static-side" role="navigation">
        	<div class="sidebar-collapse">
            	<ul class="nav" id="side-menu">
					...
					<li id="inicio" <?php if (isset($_GET['cargar']) && $_GET['cargar'] == "principal") { echo "class=\"active\"";} elseif (!isset($_GET['cargar'])) { echo "class=\"active\""; }?>>
					...
					<li id="sistema" <?php if (isset($_GET['cargar']) && ($_GET['cargar'] == "respaldo" || $_GET['cargar'] == "restauracion")) { echo "class=\"active\"";} ?>>
					...
					<li id="acercade" <?php if (isset($_GET['cargar']) && $_GET['cargar'] == "acercade") { echo "class=\"active\"";} ?>>
